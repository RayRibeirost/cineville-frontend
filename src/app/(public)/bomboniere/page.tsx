...
export default async function BombonierePage() {
  ...
  return (
    ...
    >
      {!user ? (
        <div className="rounded-xl border border-grayScale-600 bg-gray-surface px-6 py-12 text-center">
          <p className="text-sm text-grayScale-400">
            O catálogo da bomboniere está disponível para quem está logado.
          </p>
