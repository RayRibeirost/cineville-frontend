...
> = {
  "1": {
    ...
    sinopse:
      "Em um futuro distante, um explorador solitário recebe um misterioso sinal vindo de um planeta esquecido. Ao investigar sua origem, ele descobre um segredo capaz de mudar o destino da humanidade para sempre.",
    diretor: "Fulano",
    escritor: "Beltrano",
    lancamento: "xx/xx/xx",
    atores: [
      {
        ...
        foto: "/assets/img-hero.png",
      },
      {
        nome: "Fulano de tal",
        personagem: "Personagem",
        foto: "/assets/movie-Reinos-esquecidos.png",
      },
      {
        nome: "Fulano de tal",
        personagem: "Personagem",
  ...
  "2": {
    ...
    sinopse:
      "Um jovem guerreiro descobre que seu reino foi apagado da história por forças sobrenaturais. Em uma jornada épica, ele busca restaurar a memória de seu povo e enfrentar o mal que os condenou ao esquecimento.",
    diretor: "Ciclano",
    escritor: "Deltrano",
    lancamento: "xx/xx/xx",
    atores: [
...
const sessoes = [
  {
    id: 1,
    cinema: "CINEVILLE SÃO PAULO",
    endereco: "Endereço - São Paulo",
    tipo: "Legendado",
    formato: "3D",
    horarios: ["17:30", "18:30", "21:30"],
  },
  {
    id: 2,
    cinema: "CINEVILLE SÃO PAULO",
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 py-12 flex flex-col gap-16">
        <section className="flex flex-col md:flex-row gap-8">
          <div className="flex-1">
            ...
            <p className="text-grayScale-400 leading-relaxed text-sm max-w-2xl">
              {movie.sinopse}
            </p>
          </div>
        ...
        {/* Atores */}
        <section>
          <h2 className="text-3xl font-bold mb-8">Atores</h2>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 px-10">
            {movie.atores.map((ator, index) => (
              <div key={index} className="flex flex-col items-center gap-2">
                ...
                <p className="text-grayScale-400 text-xs text-center">
                  {ator.personagem}
                </p>
              </div>
            ))}
            ...
            {sessoes.map((sessao) => (
              ...
              >
                ...
                <p className="text-grayScale-400 text-xs flex items-center gap-1">
                  <LocationOn className="text-red-cinema" /> {sessao.endereco}
                </p>
